// pages/dashboard/manager/ManagerBranchDashboard.jsx
  ...
  const quickActions = [
    {
      ...
      path: `/dashboard/manager/branch/${branchId}/sales`,
    },
    {
      id: 'stock',
      ...
      path: `/dashboard/manager/branch/${branchId}/stock-requests`,
    },
    {
      id: 'transport',
      label: 'Transport',
      ...
      path: `/dashboard/manager/branch/${branchId}/transport`,
    },
    {
      id: 'daily-images',
      label: 'Store Images',
      ...
      path: `/dashboard/manager/branch/${branchId}/daily-store-images`,
    },
  ];
