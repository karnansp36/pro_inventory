...
import TransportTable from '../branch-owner/TransportTable'; // Reusing the existing table for now

const ManagerTransportPage = () => {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">Transport Overview</h1>
      ...
      <div className="lg:col-span-2">
        <TransportTable isManagerView={true} />
      </div>
    </div>
  );
};
