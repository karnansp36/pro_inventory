// pages/dashboard/manager/AdminBranchDashboard.jsx
...
const AdminBranchDashboard = () => {
  ...
  React.useEffect(() => {
    if (branchId) {
      dispatch(getStockRequestsByBranch({ branchId }));
      dispatch(getTransportsByBranch({ branchId }));
      dispatch(getDailyReportsByBranch({ branchId }));
    }
  }, [dispatch, branchId]);
  ...
  // Quick action buttons - updated to use branchId from URL
  const quickActions = [
    {
      id: 'sale',
      label: 'Sales',
      ...
      path: `sales`, // Corrected path to be relative
    },
    {
      id: 'stock',
      ...
      path: `stock-requests`, // Corrected path to be relative
    },
    {
      id: 'transport',
      label: 'Transport',
      ...
      path: `transport`, // Corrected path to be relative
    },
    {
      id: 'daily-images',
      label: 'Store Images',
      ...
      path: `daily-store-images`, // Corrected path to be relative
    },
  ];
  ...
  // Function to handle navigation with branchId
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-white/90 text-sm sm:text-base">
                Managing Manager: {branchId}
              </p>
            </div>
            <div className={`px-4 py-2 rounded-xl ${
              isDark ? 'bg-slate-900/50' : 'bg-white/20'
            } backdrop-blur-sm`}>
              <div className="text-xs text-white/70">Manager ID</div>
