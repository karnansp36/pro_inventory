// pages/dashboard/branch-owner/AdminSales.jsx
...
const AdminSales = () => {
  ...
  // Pagination and filter states for AdminSalesTable
  ...
  const calculateTotal = () => {
    const total = (parseFloat(gpay) || 0) + (parseFloat(card) || 0) + (parseFloat(cash) || 0);
    return total;
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className={`rounded-2xl overflow-hidden transition-all duration-300 ${
          ...
          <div className={`p-6 border-b ${
            isDark ? 'border-slate-700 bg-slate-800/50' : 'border-gray-200 bg-gradient-to-r from-emerald-50 to-teal-50'
          }`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`p-3 rounded-xl ${
                  ...
                  <Receipt className={`w-6 h-6 ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`} />
                </div>
                <div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className={`p-4 rounded-xl border-2 transition-all duration-300 ${
                  ...
                  />
                  {gpay && (
                    <p className={`text-xs mt-2 font-medium ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`}>
            ...
            <div className="space-y-3">
              ...
              {dailyReportError && (
                <div className={`p-4 rounded-lg flex items-start gap-3 ${
                  isDark ? 'bg-red-900/50 border border-red-700' : 'bg-red-50 border border-red-200'
                }`}>
              ...
              {!branchOwnerId && (
                <div className={`p-4 rounded-lg flex items-start gap-3 ${
                  isDark ? 'bg-yellow-900/50 border border-yellow-700' : 'bg-yellow-50 border border-yellow-200'
                }`}>
