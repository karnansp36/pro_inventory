// client/src/pages/dashboard/brand-owner/BrandOwnerUserManagement.jsx
...
import UserHierarchyTable from '../admin/UserHierarchyTable'; // Reusing for hierarchy view

const BrandOwnerUserManagement = () => {
  ...
  const handleAddUser = () => {
    setEditUser(null);
    setForm({ name: '', email: '', password: '', role: '', assignedManager: '' });
    setShowModal(true);
  };
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    const userData = { ...form };
    // Brand Owner can only create/manage Managers and Branch Owners
    if (userData.role === 'Admin' || userData.role === 'BrandOwner') {
      alert('Brand Owners cannot create or manage Admin or other Brand Owner roles.');
      return;
    }

    // Automatically assign BrandOwner to new Managers/BranchOwners created by this BrandOwner
    userData.assignedBrandOwner = currentUser._id;
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage Managers and Branch Owners under your business unit</p>
        </div>
        <button
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              {form.role === 'BranchOwner' && (
                <div>
                  ...
                  <select name="assignedManager" value={form.assignedManager} onChange={handleFormChange} className="w-full border rounded px-3 py-2">
...
export default BrandOwnerUserManagement;