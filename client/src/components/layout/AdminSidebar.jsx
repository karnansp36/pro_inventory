...
const AdminSidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { path: `/dashboard/admin/branch/${branchId}/daily-store-images`, icon: Camera, label: 'Store Images', category: 'monitoring' },
    { path: `/dashboard/admin/branch/${branchId}/profile`, icon: Users, label: 'Profile', category: 'main' },
  ];
