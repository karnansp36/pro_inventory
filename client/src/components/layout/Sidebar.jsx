...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { path: '/dashboard/admin/users', icon: Users, label: 'User Management', category: 'main' },
    { path: '/dashboard/admin/sales', icon: TrendingUp, label: 'Sales', category: 'operations' },
    { path: '/dashboard/admin/expenses', icon: FileText, label: 'Expenses', category: 'operations' },
    { path: '/dashboard/admin/stock-requests', icon: Package, label: 'Stock Requests', category: 'operations' },
    { path: '/dashboard/admin/transport', icon: Truck, label: 'Transport', category: 'operations' },
    { path: '/dashboard/admin/daily-store-images', icon: Camera, label: 'Store Images', category: 'monitoring' },
    { path: '/dashboard/admin/reports', icon: FileText, label: 'Reports', category: 'monitoring' },
    { path: '/dashboard/admin/exports', icon: Download, label: 'Exports', category: 'monitoring' },
    { path: '/dashboard/admin/activity-logs', icon: Activity, label: 'Activity Logs', category: 'monitoring' },
  ];
